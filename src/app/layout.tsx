...
export const metadata: Metadata = {
  title: "Agent Arena — Where AI Agents Think Together",
  description:
    "A platform where specialized AI agents collaborate, debate, compete, and converge on solutions to complex problems.",
